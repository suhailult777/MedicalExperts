      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
        <div className="container mx-auto p-3 flex items-center justify-between">
          <div className="flex items-center">
            <div className="bg-[#02475b] text-white p-2 rounded-full mr-3">
              <FaUserMd className="text-lg" />
            </div>
            <div>
              <p className="font-medium text-sm">Need help finding a doctor?</p>
              <p className="text-xs text-gray-500">Call us for assistance</p>
            </div>
          </div>
          <a 
            href="tel:+918045654857" 
            className="flex items-center bg-[#00b38e] text-white px-4 py-2 rounded-md"
          >
